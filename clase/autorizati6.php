...
echo '<h1><u>06.05.b</u></h1>';
echo '<form action="rezultate6.php" method=post>';
echo '<table border=0>';
echo '<tr><td style="font-size:20px;">Introduceti numele clasei:</td><td align="center"><input type="text" name="clasa" size="20" maxlength="20" style="color:red;font-size:20px;"></td></tr>';
