...
echo '<h1><u>06.06.a</u></h1>';
echo '<form action="rezultate7.php" method=post>';
echo '<table border=0>';
echo '<tr><td style="font-size:20px;">Introduceti tipul clasei:</td><td align="center"><input type="text" name="tip" size="2" maxlength="2" style="color:red;font-size:20px;"></td></tr>';
